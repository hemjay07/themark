...
- Scroll snapping is off on the story: with it on, a slow wheel scroll from the top settled back to the hero, and the pinned strip jumped a screen at its end. The strip is now a native sideways rail with arrows; the scenes remain one screen each.
